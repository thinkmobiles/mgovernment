...
module.exports = {
    ...
    //'allotheremails@ukr.net',// password: allotheremails
    ...
    EMAIL_COMPLAINSMSSPAM: 'allcomplaintra@mail.com', //'smsspam@ukr.net',// password: smsspam
    EMAIL_HELP_SALIM: 'allcomplaintra@mail.com' //'helpsalim@ukr.net'// password: helpsalim
