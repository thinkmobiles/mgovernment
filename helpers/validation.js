module.exports = new function () {
    ...
    var phoneRegExp = /^[0-9\+]?([0-9-\s()])+[0-9()]$/,
        ...
        urlSimpleRegExp = /[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&//=]*)/gi,
    ...
    var validateSimpleUrl = function (validatedString) {
        return urlSimpleRegExp.test(validatedString);
    };
   ...
   var validateRate15 = function (validatedString) {
    ...
    var checkSimpleUrlField = function(errorArray, required, fieldValue, fieldName){
        if(required && !fieldValue){
            errorArray.push([fieldName, errorMessages.requiredMsg].join(' '));
            return;
        }
        ...
        if(fieldValue && !validateSimpleUrl(fieldValue)) {
            errorArray.push([fieldName, errorMessages.invalidUrl].join(' '));
        }
    };
    ...
    return {
        ...
        checkSimpleUrlField: checkSimpleUrlField,
