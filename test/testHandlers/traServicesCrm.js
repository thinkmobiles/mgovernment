...
/*
    ...
    it('SEND complainSmsSpam Unauthorized', function (done) {
    ...
    //<editor-fold desc="Complain TRA">
    it('SEND complainTRAService', function (done) {

        var loginData = USERS.CLIENT_CRM_LOGIN_DIGI;
        var data = {
            title: 'I like TRA services',
            description: 'TRA has very cool services. I think TRA is Best of the bests of the bests... :)'
        };
    ...
    it('SEND complainTRAService Unauthorized', function (done) {
        ...
        var data = {
            ...
            description: 'TRA services has pretty developers teem. Great work'
        };
    ...
    it('SEND complainTRAService with Attachment', function (done) {

        var loginData = USERS.CLIENT_CRM_LOGIN_DIGI;
        var data = {
            title: 'I like TRA services with attachment',
            description: 'TRA has very cool services. I think TRA is Best of the bests of the bests... :)',
...
*/
    ...
    it('SEND Suggestion with Attachment', function (done) {
    ...
    it('SEND complainServiceProvider with Attachment', function (done) {
